...
RSpec.describe "/users", type: :request do 
  ...
  context "request from authorized user" do
  ...
  context "request from manager user" do
    before do
      manager_user = create(:manager_user)
      post "/login", params: { email: manager_user.email, password: manager_user.password }
    end
  ...
  context "request from admin user" do
    before do
